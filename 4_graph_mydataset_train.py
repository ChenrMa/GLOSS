...
def train(cfg, model, embedding_memory=None, continue_from_global_step=0):
    ...
    for epoch in train_iterator:
        ...
        # Evaluation
        if  cfg.test_steps > 0 and epoch % cfg.test_steps == 0:
            state_dict = model.state_dict()

            results = evaluate(cfg, state_dict, embedding_memory, prefix=str(global_step), _split="val")
...
@hydra.main(config_path="config", config_name="4_graph_mydataset_multi")
